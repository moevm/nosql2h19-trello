...
def main():
	...
	plt.savefig('./pictures/Statistic1.png')
	...
	plt.savefig('./pictures/Statistic2.png')
	...
	fig, axs = plt.subplots()
	axs.bar(names, values)
	plt.savefig('./pictures/Statistic3.png')
	...
	fig, axs = plt.subplots()
	axs.bar(names, values)
	plt.savefig('./pictures/Statistic4.png')
	...
	fig, axs = plt.subplots()
	axs.plot(names, values)
	plt.savefig('./pictures/Statistic5.png')
	...
	fig, axs = plt.subplots()
	axs.bar(names, values)
	plt.savefig('./pictures/Statistic6.png')
	...
	fig, axs = plt.subplots()
	axs.bar(names, values)
	plt.savefig('./pictures/Statistic7.png')
